#ifndef FAST_GICP_LITAMIN2_IMPL_HPP
#define FAST_GICP_LITAMIN2_IMPL_HPP
...
LiTAMIN2<PointSource, PointTarget>::LiTAMIN2() : LiTAMIN2<PointSource, PointTarget>() {
  this->reg_name_ = "LiTAMIN2";

  voxel_resolution_ = 3.0;
